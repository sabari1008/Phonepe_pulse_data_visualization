...
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | Ponsabareeswari shanmugam",
                  # page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Ponsabareeswari shanmugam*!
